...
try {
    // recupero delle lezioni del tutor
    $sql = '
        SELECT b.id AS booking_id, s.id AS slot_id, s.date, s.time, s.mode, st.username AS student_name, b.paid, t.cost_online, t.cost_presenza
        FROM bookings b
